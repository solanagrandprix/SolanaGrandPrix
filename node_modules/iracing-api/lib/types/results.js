import { z } from 'zod';
import { FarmSchema, HelmetSchema, TrackStateSchema, WeatherSchema, } from './common';
...
export const SearchSeriesParamsSchema = z
    ...
    if (data.seasonYear !== undefined ||
        ...
        return (data.seasonYear !== undefined &&
            data.seasonQuarter !== undefined);
    }
    return true;
}, {
    message: 'Both seasonYear and seasonQuarter must be provided if either is used',
});
...
export const GetResultsLapDataWithChunksResponseSchema = z.object(Object.assign(Object.assign({}, GetResultsLapDataResponseSchema.shape), { lapData: z.array(LapDataItemSchema) }));
