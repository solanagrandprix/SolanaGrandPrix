...
import { CarTypeSchema, CategorySchema, HeatSesInfoSchema, LicenseGroupTypeSchema, TrackTypeSchema, WeatherSchema, } from './common';
...
export const SeriesHeatSesInfoSchema = z.intersection(HeatSesInfoSchema, z.object({ description: z.string() }));
