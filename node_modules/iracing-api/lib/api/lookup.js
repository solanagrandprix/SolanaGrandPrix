...
export class LookupAPI extends API {
    constructor() {
         ...
         */
        this.getClubHistory = async (params) => await this._getData('data/lookup/club_history', {
         ...
         */
        this.getCountries = async () => await this._getData('data/lookup/countries');
        /**
         ...
         */
        this.getDrivers = async (params) => await this._getData('data/lookup/drivers', {
         ...
         */
        this.getLicenses = async () => await this._getData('data/lookup/licenses');
        /**
         ...
         */
        this.getLookupData = async () => await this._getData('data/lookup/get');
    }
}
